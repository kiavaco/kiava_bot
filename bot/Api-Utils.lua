...
function options(msg, GP_id)
    ...
    edit_inline(msg.message_id, MaTaDoR, keyboard)
end
...
local M_START = StartPm[math.random(#StartPm)]
	...
	keyboard.inline_keyboard = {
		{
			{text = M_START..'حداکثر پیام های مکرر ', callback_data = 'MaTaDoRTeaM:'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(NUM_MSG_MAX), callback_data = 'MaTaDoRTeaM:' },
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = M_START..'حداکثر حروف مجاز ', callback_data = 'MaTaDoRTeaM:'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(SETCHAR), callback_data = 'MaTaDoRTeaM:'},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = M_START..'زمان بررسی پیام های مکرر ', callback_data = 'MaTaDoRTeaM:'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(TIME_CHECK), callback_data = 'MaTaDoRTeaM:'},
...
function addlimpanel(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
			{text = M_START..'محدودیت اضافه کردن : '..getadd..'', callback_data = 'MaTaDoRTeaM:'..GP_id}
		},
		{
		...
		{
			{text = M_START..'وضعیت محدودیت : '..sadd..'', callback_data = 'MaTaDoRTeaM:'..GP_id}
		},
		{
		...
		{
			{text = M_START..'ارسال پیام محدودیت : '..addpm..'', callback_data = 'MaTaDoRTeaM:'..GP_id}
		},
		{
