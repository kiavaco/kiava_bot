...
if msg.query and msg.query:sub(1,6) == "Addl:-" and msg.query:gsub("Addl:-",""):match('%d+') and is_sudo(msg) then
	...
	keyboard.inline_keyboard = {
		{
			{text = M_START..'محدودیت اضافه کردن : '..getadd..'', callback_data = 'MaTaDoRTeaM:'..chatid}
		},
		{
		...
		{
			{text = M_START..'وضعیت محدودیت : '..sadd..'', callback_data = 'MaTaDoRTeaM:'..chatid}
		},
		{
		...
		{
			{text = M_START..'ارسال پیام محدودیت : '..addpm..'', callback_data = 'MaTaDoRTeaM:'..chatid}
		},
		{
